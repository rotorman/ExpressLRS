...
public:
    ...
    void displayIdleScreen(uint8_t changed, uint8_t rate_index, uint8_t power_index, uint8_t ratio_index, bool dynamic, uint8_t running_power_index, message_index_t message_index);
